...
class StudentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(pastName != null){
      return cardCopyWith(Colors.blue, listTileCopyWith(pastName!));
    }
    return cardCopyWith(Colors.blue.shade100,
      FutureBuilder<DocumentSnapshot>(
        future: DatabaseServicesStudent().studentCollection.doc(studentUid)
            .get(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Map<String, dynamic>? studentData = snapshot.data!.data()! as Map<
                String,
                dynamic>?;
